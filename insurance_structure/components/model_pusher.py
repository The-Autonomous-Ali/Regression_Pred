...
from insurance_structure.entity.artifact_entity import ModelPusherArtifact, ModelTrainerArtifact 
from insurance_structure.entity.config_entity import ModelPusherConfig
...
class ModelPusher:
    def __init__(self,model_trainer_artifact: ModelTrainerArtifact,
        ...
        self.stroke_estimator = InsurancePriceEstimator(
